const ReplyIcon = ({color, width, height}) => {
    return (
        ...
        fill={color || '#6e767d'} 
        width={width || 24}
        height={height || 24} viewBox="0 0 24 24" aria-hidden="true">
            <g>
...
const VerifiedIcon = ({color, width, height})=>{
    return(
        ...
        fill={color || '#fff'} 
        width={width || 24}
        height={height || 24} viewBox="0 0 24 24" aria-label="Onaylanmış hesap" className="verified-icon">
            <g>
...
export {ReplyIcon, RetweetIcon, HeartIcon, ShareIcon, VerifiedIcon};